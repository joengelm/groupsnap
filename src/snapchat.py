...
class Snapchat(object):
    ...
    def _getURL(self):
        ...
        #return "http://www.gmodules.com/ig/proxy?url=https://" + str(rnum) + ".feelinsonice-hrd.appspot.com/bq"
    ...
    def post(self, endpoint, data, params, filec=None):
        ...
        :param filec: Optional field for submitting file content in multipart messages.
        """
        ...
        if filec:
            r = requests.post(url, data, headers=headers, files={'data': filec})
        else:
    ...
    def add_story(self, media_id, media_type, caption, time=10):
    ...
    def clear_feed(self):
        ...
        r = self.post('/update_snaps', data, params)
        return result != False
    ...
    def get_snaps(self):
        ...
        for snap in snaps:
            ...
            if snap_readable['status'] > 1 or snap_readable['sender'] == None:
                continue
